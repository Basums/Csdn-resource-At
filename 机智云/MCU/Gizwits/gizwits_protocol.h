...
* @{
*/
#define PRODUCT_KEY "cb6a7f2d81c1436ca733b06ab3640cf1"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "f8b673c03e424497b0e0fa99d3011553"
...
* @{
*/
#define led_switch_BYTEOFFSET                    0
#define led_switch_BITOFFSET                     0
#define led_switch_LEN                           1

#define temp_setting_001_RATIO                         0.1
#define temp_setting_001_ADDITION                      -10
#define temp_setting_001_MIN                           0
#define temp_setting_001_MAX                           600
#define temp_setting_002_RATIO                         0.1
#define temp_setting_002_ADDITION                      -10
#define temp_setting_002_MIN                           0
#define temp_setting_002_MAX                           600
#define temp_seting_003_RATIO                         0.1
#define temp_seting_003_ADDITION                      -10
#define temp_seting_003_MIN                           0
#define temp_seting_003_MAX                           600
...
typedef enum
{
  ...
  EVENT_led_switch,
  EVENT_temp_setting_001,
  EVENT_temp_setting_002,
  EVENT_temp_seting_003,
...
typedef struct {
  bool valueled_switch;
  float valuetemp_setting_001;
  float valuetemp_setting_002;
  float valuetemp_seting_003;
  float valuetemp;
} dataPoint_t;
...
typedef struct {
  uint8_t flagled_switch:1;
  uint8_t flagtemp_setting_001:1;
  uint8_t flagtemp_setting_002:1;
  uint8_t flagtemp_seting_003:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valuetemp_setting_001;
  uint16_t valuetemp_setting_002;
  uint16_t valuetemp_seting_003;
} attrVals_t;
