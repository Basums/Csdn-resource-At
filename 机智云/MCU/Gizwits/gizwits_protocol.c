...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagled_switch)
    {
        info->event[info->num] = EVENT_led_switch;
        info->num++;
        dataPoints->valueled_switch = gizStandardDecompressionValue(led_switch_BYTEOFFSET,led_switch_BITOFFSET,led_switch_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
        
    if(0x01 == issuedData->attrFlags.flagtemp_setting_001)
    {
        info->event[info->num] = EVENT_temp_setting_001;
        info->num++;
        dataPoints->valuetemp_setting_001 = gizX2YFloat(temp_setting_001_RATIO,  temp_setting_001_ADDITION, (float)(exchangeBytes(issuedData->attrVals.valuetemp_setting_001)));
    }
        
    if(0x01 == issuedData->attrFlags.flagtemp_setting_002)
    {
        info->event[info->num] = EVENT_temp_setting_002;
        info->num++;
        dataPoints->valuetemp_setting_002 = gizX2YFloat(temp_setting_002_RATIO,  temp_setting_002_ADDITION, (float)(exchangeBytes(issuedData->attrVals.valuetemp_setting_002)));
    }
        
    if(0x01 == issuedData->attrFlags.flagtemp_seting_003)
    {
        info->event[info->num] = EVENT_temp_seting_003;
        info->num++;
        dataPoints->valuetemp_seting_003 = gizX2YFloat(temp_seting_003_RATIO,  temp_seting_003_ADDITION, (float)(exchangeBytes(issuedData->attrVals.valuetemp_seting_003)));
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valuetemp_setting_001 != cur->valuetemp_setting_001)
    {
        GIZWITS_LOG("valuetemp_setting_001 Changed\n");
        ret = 1;
    }
    if(last->valuetemp_setting_002 != cur->valuetemp_setting_002)
    {
        GIZWITS_LOG("valuetemp_setting_002 Changed\n");
        ret = 1;
    }
    if(last->valuetemp_seting_003 != cur->valuetemp_seting_003)
    {
        GIZWITS_LOG("valuetemp_seting_003 Changed\n");
        ret = 1;
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    gizStandardCompressValue(led_switch_BYTEOFFSET,led_switch_BITOFFSET,led_switch_LEN,(uint8_t *)devStatusPtr,dataPoints->valueled_switch);
    gizByteOrderExchange((uint8_t *)devStatusPtr->wBitBuf,sizeof(devStatusPtr->wBitBuf));


    devStatusPtr->valuetemp_setting_001 = exchangeBytes(gizY2XFloat(temp_setting_001_RATIO,  temp_setting_001_ADDITION, dataPoints->valuetemp_setting_001));     
    devStatusPtr->valuetemp_setting_002 = exchangeBytes(gizY2XFloat(temp_setting_002_RATIO,  temp_setting_002_ADDITION, dataPoints->valuetemp_setting_002));     
    devStatusPtr->valuetemp_seting_003 = exchangeBytes(gizY2XFloat(temp_seting_003_RATIO,  temp_seting_003_ADDITION, dataPoints->valuetemp_seting_003));     
