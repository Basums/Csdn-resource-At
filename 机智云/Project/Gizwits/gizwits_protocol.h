...
* @{
*/
#define PRODUCT_KEY "93aa197924af4f03b9946da919f0dc41"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "67822da679a042908d18bab28ecaefa4"
...
#define temperature_UPX_RATIO                         0.1
#define temperature_UPX_ADDITION                      -10
#define temperature_UPX_MIN                           0
#define temperature_UPX_MAX                           1100
#define temperature_UPX_LEN                           2
#define temperature_Gizwits_RATIO                         0.1
#define temperature_Gizwits_ADDITION                      -10
#define temperature_Gizwits_MIN                           0
#define temperature_Gizwits_MAX                           1100
#define temperature_Gizwits_LEN                           2
...
typedef struct {
  ...
  float valuetemperature_UPX;
  float valuetemperature_Gizwits;
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
  uint8_t flagLED_Switch:1;
  uint8_t flagtemperature_UPX:1;
  uint8_t flagtemperature_Gizwits:1;
} dataPointFlags_t;
...
typedef struct {
  ...
  uint16_t valuetemperature_UPX;
  uint16_t valuetemperature_Gizwits;
} devStatus_t;
